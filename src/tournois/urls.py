...
urlpatterns = [
    ...
    path('count-single/', views.count_tournaments_starting_with_single, name='count-single-tournois'),
    path('count-double/', views.count_tournaments_starting_with_double, name='count-double-tournois'),
